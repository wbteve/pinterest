...
<table cellpadding="4" cellspacing="0" border="0" class="table-form">
	<tr>
		<th width="150"><?php echo L("SECOND_STATUS");?></th>
		<td>
			<label><input type="radio" name="SECOND_STATUS" value="1" <?php if($settings["SECOND_STATUS"] == 1): ?>checked="checked"<?php endif; ?> /><span><?php echo L("YES");?></span></label>
			<label><input type="radio" name="SECOND_STATUS" value="0" <?php if($settings["SECOND_STATUS"] == 0): ?>checked="checked"<?php endif; ?> /><span><?php echo L("NO");?></span></label>
		</td>
	</tr>
	<tr>
		<th><?php echo L("SECOND_TAOBAO_FORUMID");?></th>
		<td><input type="text" class="textinput" name="SECOND_TAOBAO_FORUMID" size="60" value="<?php echo ($settings["SECOND_TAOBAO_FORUMID"]); ?>" /></td>
	</tr>
	<tr>
		<th><?php echo L("SECOND_TAOBAO_SIGN");?></th>
		<td><input type="text" class="textinput" name="SECOND_TAOBAO_SIGN" size="100" value="<?php echo ($settings["SECOND_TAOBAO_SIGN"]); ?>" /></td>
	</tr>
	<tr>
		<th><?php echo L("SECOND_ARTICLES");?></th>
		<td><textarea class="areainput" rows="16" name="SECOND_ARTICLES"><?php echo ($settings["SECOND_ARTICLES"]); ?></textarea></td>
	</tr>
	<tr class="act">
		<th>&nbsp;</th>
		<td>
