...
<table cellpadding="4" cellspacing="0" border="0" class="table-form">
	<tr>
		<th width="150"><?php echo L("ALBUM_DEFAULT_TAGS");?></th>
		<td><input type="text" class="textinput" name="ALBUM_DEFAULT_TAGS" size="80" value="<?php echo ($settings["ALBUM_DEFAULT_TAGS"]); ?>" /></td>
	</tr>
	<tr>
		<th>&nbsp;</th>
		<td><p><?php echo L("ALBUM_DEFAULT_TAGS_TIPS");?></p></td>
	</tr>
	<tr>
		<th><?php echo L("ALBUM_TAG_COUNT");?></th>
		<td><input type="text" class="textinput" name="ALBUM_TAG_COUNT" size="10" value="<?php echo ($settings["ALBUM_TAG_COUNT"]); ?>" /></td>
	</tr>
	<tr class="act">
		<th>&nbsp;</th>
		<td>
