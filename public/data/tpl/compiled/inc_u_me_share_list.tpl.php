...
0
|| checkTplRefresh('./tpl/pink2/inc/u/me_share_list.htm', './tpl/pink2/inc/share/tags.htm', 1325601802, './data/tpl/compiled/inc_u_me_share_list.tpl.php', './tpl/pink2', 'inc/u/me_share_list')
|| checkTplRefresh('./tpl/pink2/inc/u/me_share_list.htm', './tpl/pink2/inc/pages.htm', 1325601802, './data/tpl/compiled/inc_u_me_share_list.tpl.php', './tpl/pink2', 'inc/u/me_share_list')
;?>
<? if(empty($share_list)) { ?>
<div class="empty">
...
<? if($share_item['type'] == 'fav') { ?> 
<div class="t_tag"> <a class="t" href="<?=$parent_share['url']?>" target="_blank"><?=$share_item['time']?></a> </div>
<div class="fav_label">
<div class="fl_p">
<div><?php echo setTplUserFormat($share_item['uid'],1,0,'s',24,'','icard r3 lazyload',''); ?><?php echo setTplUserFormat($share_item['uid'],0,0,'',0,'icard n gc','',''); ?><span>喜欢这个分享</span>
</div>
<i></i>
</div>
</div><?php $share_item = $parent_share; } else { ?> 
...
<p class="sms">
@<?php echo setTplUserFormat($relay_share['uid'],0,0,'',0,'icard n','',''); ?>：<?php echo cutStr($relay_share['content'],200,'...');?> <a href="<?=$relay_share['url']?>" target="_blank">原文转发(<?=$relay_share['relay_count']?>)</a>  <a href="<?=$relay_share['url']?>" target="_blank">原文评论(<?=$relay_share['comment_count']?>)</a>
</p>
