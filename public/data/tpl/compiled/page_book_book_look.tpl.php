...
0
|| checkTplRefresh('./tpl/pink2/page/book/book_look.htm', './tpl/pink2/inc/pages.htm', 1331265986, './data/tpl/compiled/page_book_book_look.tpl.php', './tpl/pink2', 'page/book/book_look')
;?>
<?php 
...
<a class="c" href="<?php echo FU('book/look',array()); ?>">晒&nbsp;&nbsp;&nbsp;&nbsp;货</a>
<a href="<?php echo FU('style',array()); ?>">精选搭配</a>
</li><?php $tag_index = 1; if(is_array($category_tags)) { foreach($category_tags as $key => $cate) { ?><li<? if($tag_index == 4) { ?> class="w17"<? } ?>>
...
<div class="show_style new_shop">
<a href="<?php echo FU('u/me',array()); ?>"><img src="./tpl/images/my_shaihuo.png"></a>
</div>
</li> 
</ul> 
...
<div class="hd"></div>
<div class="bd">
<ul class="pic"><? if(is_array($share['look_imgs'])) { foreach($share['look_imgs'] as $share_img) { ?><li>
...
jQuery(function(){<!--dynamic getShareByUserClickShareID--><!--dynamic getManageDynamic args=book_look-->if($.browser.msie&&($.browser.version == "6.0")&&!$.support.style)
{
return ;
}
else{
