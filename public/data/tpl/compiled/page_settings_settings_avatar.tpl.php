...
<form id="avartarForm" method="POST" action="<?php echo FU('settings/saveavatar',array()); ?>">
<input type="hidden" name="action" value="avatar" />
<dl>
<dd>当前头像：</dd>
<dt><img class="head_bd r3" width="100" src="<?php echo avatar($_FANWE['uid'],'b',$_FANWE['user']['server_code'],1);?>?<?=TIME_UTC?>" alt=""></dt>
<dd>上传新头像：</dd>
