...
0
|| checkTplRefresh('./tpl/pink2/page/shop/shop_show.htm', './tpl/pink2/inc/u/u_share_list.htm', 1325606401, './data/tpl/compiled/page_shop_shop_show.tpl.php', './tpl/pink2', 'page/shop/shop_show')
|| checkTplRefresh('./tpl/pink2/page/shop/shop_show.htm', './tpl/pink2/inc/share/tags.htm', 1325606401, './data/tpl/compiled/page_shop_shop_show.tpl.php', './tpl/pink2', 'page/shop/shop_show')
|| checkTplRefresh('./tpl/pink2/page/shop/shop_show.htm', './tpl/pink2/inc/pages.htm', 1325606401, './data/tpl/compiled/page_shop_shop_show.tpl.php', './tpl/pink2', 'page/shop/shop_show')
;?>
<?php 
$css_list[0]['url'] = './tpl/css/tweetlist.css';
$css_list[1]['url'] = './tpl/css/shop.css';
$js_list[0] = './tpl/js/shop.js';
 include template('inc/header'); ?><div id="body" class="fm960"> 
<div class="shop_wrapper">
<h1 style="float: none; font-size: 24px; padding: 13px 10px;"><?=$shop['shop_name']?></h1>
<div class="shop_sidebar box_shadow">
<div class="shop_summary">
<div>
<? if(!empty($shop['shop_logo'])) { ?>
<a href="<?=$shop['to_url']?>" target="_blank"><img width="80" height="80" style="border: 1px solid #e0e0e0;" src="<?=$shop['shop_logo']?>"/></a>
<? } ?>
</div>
<div class="title"><?=$shop['shop_name']?></div>
<a href="<?=$shop['to_url']?>" target="_blank">去这家店逛逛</a> </div>
<div class="section">
<h3 class="section_title">店铺看点</h3>
<div class="shop_topic" style="width: 220px; height: 60px; overflow: hidden;"><? if(is_array($shop['tags'])) { foreach($shop['tags'] as $tag) { ?><a class="item" href="<? echo FU('book/shopping',array('tag'=>urlencode($tag))); ?>" target="_blank"><?=$tag?></a>
<? } } ?>
...
<span><a href="<?php echo FU('shop/index',array()); ?>" target="_blank">更多>></a></span>推荐这家店铺的人还在逛
</h3>
<div class="relative_shop"><? if(is_array($shops_tags['shops'])) { foreach($shops_tags['shops'] as $shop_item) { ?><div class="item" >
<a href="<?=$shop_item['url']?>" target="_blank" title="<?=$shop_item['shop_name']?>"><img width="80" height="80" src="<?=$shop_item['shop_logo']?>"/></a><br/>
<a href="<?=$shop_item['url']?>" class="link red" target="_blank" title="<?=$shop_item['shop_name']?>"><?php echo cutStr($shop_item['shop_name'],26,'...');?></a>
</div>
<? } } ?>
<div class="clear-fix"></div>
</div>
...
<div class="section">
<h3 class="section_title">
<span><a href="<?php echo FU('book/shopping',array()); ?>" target="_blank">更多>></a></span>推荐这家店铺的人还在看
</h3>
<div class="attr_list" style="width: 230px;"><? if(is_array($shops_tags['tags'])) { foreach($shops_tags['tags'] as $tag) { ?><a class="attr" href="<? echo FU('book/shopping',array('tag'=>urlencode($tag))); ?>" target="_blank"><?=$tag?></a>
<? } } ?>
<div class="clear-fix"></div>
</div>
</div>
</div>
<div class="shop_body box_shadow">
<div class="c_tab" style="margin-bottom: 15px;">
<a style="margin-left: 0;" class="c_tab_btn_current">大家推荐的</a>
</div><? if(empty($share_list)) { ?>
<div class="empty">
...
<div class="clear-fix"></div>
</div><? include template('inc/footer'); ?><script type="text/javascript">
jQuery(function(){
<? if(getIsManage('share')) { ?>
$('#SHARE_DETAIL_LiST .t_f').hover(function(){
