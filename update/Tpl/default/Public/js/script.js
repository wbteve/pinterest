function startInstall()
{
	...
	$.ajax({
		  url: APP+"?"+VAR_MODULE+"=Index&"+VAR_ACTION+"=install&DB_HOST="+DB_HOST+"&DB_NAME="+DB_NAME+"&DB_USER="+DB_USER+"&DB_PWD="+DB_PWD+"&DB_PORT="+DB_PORT+"&DB_PREFIX="+DB_PREFIX+"&DEMO_DATA="+DEMO_DATA,
		  cache: false,
